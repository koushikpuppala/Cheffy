						...
						<div className='py-2'>
							<div className={style.main_card}>
								...
								<div className='d-flex col-7 px-4 flex-column'>
									...
									<div className='d-flex flex-row p-3 bg-info bg-opacity-10 justify-content-between rounded'>
									...
									<div className='d-flex justify-content-evenly pt-2'>
										<button className={style.btn_view}>View on Map</button>
