									...
									<div className='col-6 px-2'>
										<div className='py-1'>
											<div
												...
												<img
													src='/images/Inside_city_center_1.svg'
													alt=''
												/>
										...
										<div className='py-1'>
											<div
												className={`d-flex flex-column justify-content-center align-items-center text-center ${style.highlight_card}`}>
												<img src='/images/Excellent view 1.svg' alt='' />
												<h5>
													Excellent <br /> view
												</h5>
											</div>
									...
									<div className='col-6 px-2'>
										<div className='py-1'>
											<div
												className={`d-flex flex-column justify-content-center align-items-center text-center ${style.highlight_card}`}>
												<img
													src='/images/Front desk [24-hour] 1.svg'
													alt=''
												/>
										...
										<div className='py-1'>
											<div
												className={`d-flex flex-column justify-content-center align-items-center text-center ${style.highlight_card}`}>
												<img src='/images/Sparkling clean 2.svg' alt='' />
